...
Another challenge that we came across during development was the character creation. That ended up being a bit more complex than previously thought.
...
I am not sure if we are going to continue work on this or not. Perhaps if we added more to it and cleaned it up a bit, we could potentially put it on the Steam gamestore. But we are not sure.
We accomplished everything we set out to do and then some. The only thing we wish we had implemented was the inventory system and items.
All in all, this was a fun project. We enjoyed working on it, despite dealing with the wonkiness of WPF. Perhaps we will transfer this idea over to a sufficient game engine.
